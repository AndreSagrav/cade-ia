...
export const AI_MODELS: Record<string, AIModel> = {
  ...
  'or-llama4-scout': {
    id: 'or-llama4-scout',
    label: 'Llama 4 Scout (OR)',
    provider: 'openrouter',
    apiModelId: 'meta-llama/llama-4-scout-17b-16e-instruct:free',
    maxTokens: 8192,
  ...
  'or-llama4-maverick': {
    ...
    label: 'Llama 4 Maverick (OR)',
    provider: 'openrouter',
    apiModelId: 'meta-llama/llama-4-maverick-17b-128e-instruct:free',
    maxTokens: 8192,
    contextWindow: 1000000,
    cost: { input: 0, output: 0 },
    capabilities: ['code', 'reasoning'],
  ...
  'or-phi4-reasoning': {
    id: 'or-phi4-reasoning',
    label: 'Phi-4 Reasoning (OR)',
    provider: 'openrouter',
    apiModelId: 'microsoft/phi-4-reasoning-plus:free',
    maxTokens: 8192,
    contextWindow: 32768,
    cost: { input: 0, output: 0 },
    capabilities: ['code', 'reasoning'],
  ...
  'or-devstral': {
    id: 'or-devstral',
    label: 'Devstral Small (OR)',
    provider: 'openrouter',
    apiModelId: 'mistralai/devstral-small:free',
    maxTokens: 8192,
    contextWindow: 128000,
    cost: { input: 0, output: 0 },
    capabilities: ['code'],
  ...
  'or-glm4-32b': {
    ...
    label: 'GLM-4 32B (OR)',
    provider: 'openrouter',
    apiModelId: 'thudm/glm-4-32b:free',
    maxTokens: 8192,
    contextWindow: 128000,
    cost: { input: 0, output: 0 },
    capabilities: ['code', 'reasoning'],
  ...
  'or-olympiccoder-32b': {
    id: 'or-olympiccoder-32b',
    label: 'OlympicCoder 32B (OR)',
    provider: 'openrouter',
    apiModelId: 'open-r1/olympiccoder-32b:free',
    maxTokens: 8192,
    contextWindow: 32768,
    cost: { input: 0, output: 0 },
    capabilities: ['code'],
